...
namespace Ejercicio3
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int cant = 0;
            Double total = 0, parcial = 0,  prec = 0;
            do
            {
        ...
        {
            Console.WriteLine("Ingrese el precio del producto, use la coma (,) para usar decimales");
            string Precio = Console.ReadLine();
            bool error = Double.TryParse(Precio, out Double precio);
            if (!error)
            {
